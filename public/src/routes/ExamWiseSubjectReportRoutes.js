...
const controller = require('../controller/ExamWiseSubjectReportController');
...
// API route to get exam names dynamically
router.post('/exam-names', controller.getExamNames);
