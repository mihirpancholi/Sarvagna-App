...
(2, 'November', 2025, NULL, '2025-10-13', NULL, '2025-10-13 12:57:39', 1, NULL, NULL, 'N', NULL, NULL),
(3, 'June', 2025, NULL, '2025-06-25', NULL, '2025-10-13 13:10:12', 1, NULL, NULL, 'N', NULL, NULL);
...
(4, 2, 9, 1, 'video', '2025-10-13 12:57:39', 1, NULL, NULL, 'N', NULL, NULL),
(5, 2, 6, 1, 'jay aksharpati', '2025-10-13 12:57:39', 1, NULL, NULL, 'N', NULL, NULL),
(6, 2, 10, 1, 'lago chho pyara', '2025-10-13 12:57:39', 1, NULL, NULL, 'N', NULL, NULL),
(7, 3, 2, 1, '', '2025-10-13 13:10:12', 1, NULL, NULL, 'N', NULL, NULL),
(8, 3, 2, 2, '', '2025-10-13 13:10:12', 1, NULL, NULL, 'N', NULL, NULL),
(9, 3, 2, 3, '', '2025-10-13 13:10:12', 1, NULL, NULL, 'N', NULL, NULL);
...
CREATE TRIGGER `sevak_role_update` AFTER INSERT ON `nirikshak_master` FOR EACH ROW BEGIN
    UPDATE sevak_master SET role_id = 3 WHERE sevak_id = NEW.sevak_id;
  END
$$
DELIMITER ;
...
(1, NULL, 'S', 3, 'Y', '1234', 2, NULL, 'YTK2025S109', '109', 'John', 'R.', 'Doe', '1990-01-01', 1, 1, 1, '', 1, '2015-05-20', 'photo.jpg', 'latest_photo.jpg', 1, 1, 1, 1, 1, 1, '123456', '123 Main St', 'Apt 101', 'Y', 1, 1, 1, 1, 1, 1, '123456', '123 Permanent St', 'Apt 101', '', 1, 1, 1, 1, 1, 1, '123456', 'Talim Address 1', 'Talim Address 2', 'Reference Name', 1, '91', '9876543210', 'Instructor Name', 1, '91', '9876543210', '91', '9988776655', '91', '9988776644', '0221234567', '0221234568', '91', '9988776655', '1', '0229876543', '0229876542', 'dhruvtankudemy29@gmail.com', 'dhruvtankudemy29@gmail.com', 1, 'Sant Nirdeshak', 'Nirdeshak', 'Mandir A', 'Type A', 1, 'Talim Sant', 'Talim Nirdeshak', 'Talim Mandir', 'Type A', 1, 'Current Sant', 'Current Nirdeshak', 'Current Mandir', 'Type A', '2010-01-01', 'Satsang Remark', 'Achievement', 'Achievement Remarks', '1', '2025-09-02 10:53:03', 1, 'IN', '2025-09-02 05:23:03', 0, 'N', NULL, NULL, 'Satsa', 0, 0, 'Inspi', 0, 0, '123456', '2025-09-02 05:23:03', 'Y', 'N', 'Y', '2025-09-02', 'Admitted Remark', 'Y', '2025-09-02', 'Certified Remark', 'Y', '2025-09-02', 'Not Complete Remark', 'N', '2025-09-02', 'Temporary Remark', 'N', '2025-09-02', 'Expired Remark', 'N', '2025-09-02', 'Sant in BAPS Remark', 'Parshad', '2025-09-02', 'Sant', 1, 1, '2025-09-02 10:53:03', '2025-09-02 10:53:03', '2025-09-02 10:53:03', 'Mandal Name', '2010-01-01', 'Goshthi Status');
...
(1, 1, 1, NULL, '2025-09-02 05:31:18');
...
--
ALTER TABLE `exam_mark_entry_master`
  MODIFY `mark_entry_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `exam_type_master`
  MODIFY `examtype_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `gosthi_master`
  MODIFY `gosthi_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `gosthi_schedule`
  MODIFY `gosthi_schedule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `gosthi_schedule_detail`
--
ALTER TABLE `gosthi_schedule_detail`
  MODIFY `gosthi_schedule_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `gosthi_topic_type_master`
--
ALTER TABLE `gosthi_topic_type_master`
  MODIFY `gosthi_topic_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `group_member_mapping`
  MODIFY `group_member_mapping_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sevak_employment`
  MODIFY `sevak_employment_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sevak_evaluation`
--
ALTER TABLE `sevak_evaluation`
  MODIFY `sevak_evaluation_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sevak_family`
--
ALTER TABLE `sevak_family`
  MODIFY `sevak_family_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sevak_master`
--
ALTER TABLE `sevak_master`
  MODIFY `sevak_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `sevak_role`
--
ALTER TABLE `sevak_role`
  MODIFY `sevak_role_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `sevak_satsang`
--
ALTER TABLE `sevak_satsang`
  MODIFY `sevak_satsang_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sevak_talent`
--
ALTER TABLE `sevak_talent`
  MODIFY `sevak_talent_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `exam_master`
  ADD CONSTRAINT `exam_master_ibfk_1` FOREIGN KEY (`sevak_id`) REFERENCES `sevak_master` (`sevak_id`),
...
ALTER TABLE `exam_schedule_master`
  ...
  ADD CONSTRAINT `exam_schedule_master_ibfk_2` FOREIGN KEY (`sevak_id`) REFERENCES `sevak_master` (`sevak_id`),
...
--
-- Constraints for table `exam_type_master`
--
ALTER TABLE `exam_type_master`
  ADD CONSTRAINT `exam_type_master_ibfk_1` FOREIGN KEY (`sevak_id`) REFERENCES `sevak_master` (`sevak_id`);
