...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 10, 2025 at 09:23 AM
...
--
ALTER TABLE `gosthi_schedule`
  MODIFY `gosthi_schedule_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gosthi_schedule_detail`
--
ALTER TABLE `gosthi_schedule_detail`
  MODIFY `gosthi_schedule_detail_id` int(11) NOT NULL AUTO_INCREMENT;
